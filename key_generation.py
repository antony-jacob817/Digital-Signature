...
# Global variables to store keys and messages
...
def status_display(message, color, font_size):
    status.clear()
    status.color(color)
    status.goto(0, -170)  # Positioned below buttons
...
# Set up enhanced Turtle Screen
screen = turtle.Screen()
screen.title("🔐 Digital Signature System")
screen.bgcolor("#1A1A1A")  # Dark theme
...
# Status Text initialization (Moved below buttons)
